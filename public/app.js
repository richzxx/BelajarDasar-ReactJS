...
console.log('Compile Otomatis'); // React JS returnnya = Objek Literal
...
function time() {
  return /*#__PURE__*/React.createElement("p", null, new Date().toLocaleTimeString());
}
...
function tampilkan() {
  ...
  }), time(), item1, // Buat Scroll jauh ke bawah
